...
- **[Quick Start](./instructor/quickstart)** - Get up and running in 5 minutes
- **[Setup Guide](./instructor/setup)** - Detailed installation and configuration
...
- **[Instructor](./instructor/introduction)** - Main structured output library
- **[Polyglot](./polyglot/overview)** - Low-level LLM abstraction layer  
- **[HTTP Client](./http/1-overview)** - Flexible HTTP client for API calls
- **[HTTP Pool](./http-pool/overview)** - Concurrent request execution for fan-out workloads
