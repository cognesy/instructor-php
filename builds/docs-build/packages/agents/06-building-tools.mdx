...
If you need lower-level patterns, see [Building Tools: Advanced Patterns](17-building-tools-advanced).
...
- [Building Tools: Advanced Patterns](17-building-tools-advanced)
