...
- [Templates](04-templates) — use Twig files for content that's easier to maintain as markup
- [Structured Data](05-structured-data) — render lists, criteria, and taxonomies with NodeSet
