...
- [Making Requests](3-making-requests.md) -- learn about request construction, HTTP methods, headers, and bodies.
- [Handling Responses](4-handling-responses.md) -- read buffered content, inspect headers, and decode JSON.
- [Streaming Responses](5-streaming-responses.md) -- consume chunked data as it arrives.
- [Middleware](10-middleware.md) -- add retry logic, circuit breakers, and custom behaviors.
