...
| See practical examples | [Cookbook](/cookbook/introduction) |
...
**Need help?** Check out the [Cookbook](/cookbook/introduction) for 60+ working examples, or [open an issue](https://github.com/cognesy/instructor-php/issues) on GitHub.
