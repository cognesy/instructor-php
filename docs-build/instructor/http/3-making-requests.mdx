...
description: 'Learn how to create and send HTTP requests using the unified HTTP client API.'
---

The unified HTTP client API provides a flexible and consistent way to create and send HTTP requests across different client implementations. This chapter covers the details of building and customizing HTTP requests.
