...
use Cognesy\Agents\Builder\AgentBuilder;use Cognesy\Agents\Capabilities\Metadata\UseMetadataTools;use Cognesy\Agents\Capabilities\StructuredOutput\SchemaDefinition;use Cognesy\Agents\Capabilities\StructuredOutput\StructuredOutputPolicy;use Cognesy\Agents\Capabilities\StructuredOutput\UseStructuredOutputs;use Cognesy\Agents\Capability\StructuredOutput\SchemaRegistry;use Cognesy\Agents\Collections\Tools;use Cognesy\Agents\Data\AgentState;use Cognesy\Agents\Events\Support\AgentConsoleLogger;use Cognesy\Agents\Tool\Tools\BaseTool;use Cognesy\Messages\Messages;use Symfony\Component\Validator\Constraints as Assert;
