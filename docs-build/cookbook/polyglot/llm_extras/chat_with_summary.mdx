...
use Cognesy\Addons\Core\Processors\Chat\MoveMessagesToBuffer;
use Cognesy\Addons\Core\Processors\Chat\SummarizeBuffer;
...
$chat = ChatFactory::default(
    ...
    continuationCriteria: new ContinuationCriteria(
        ChatCriteria::stepsLimit(12),
        ChatCriteria::responseContentCheck(static fn(Message $lastResponse): bool => $lastResponse->content() !== ''),
    ),
