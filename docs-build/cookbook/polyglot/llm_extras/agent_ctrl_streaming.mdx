---
title: 'Agent Ctrl - Streaming Usage'
docname: 'agent_ctrl_streaming'
---

## Overview

This example demonstrates real-time streaming with tool call visibility using AgentCtrl.
You can see each step as the agent searches the codebase and processes information
in real time.
...
- **Tool Call Visibility**: Monitor each tool usage during execution
- **Turn Management**: Control maximum interaction turns
- **Callback Handlers**: Custom event handling for text and tool usage
- **Performance Tracking**: Monitor token usage and execution costs