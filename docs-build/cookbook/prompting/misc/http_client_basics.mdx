...
This example demonstrates the basic usage of the HTTP Client for making simple
requests with mocked responses.
...
- **Mock HTTP Responses**: Test without real network calls
- **Request Building**: Fluent API for creating HTTP requests
- **Response Handling**: Easy access to status, headers, and body
- **Client Configuration**: Builder pattern for client setup
