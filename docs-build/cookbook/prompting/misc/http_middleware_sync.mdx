...
This example demonstrates HTTP middleware for synchronous responses. It shows
how to modify requests before sending and transform response bodies after receiving.
...
- **Request Modification**: Add headers, transform body before sending
- **Response Transformation**: Process and modify response data
- **JSON Processing**: Parse and manipulate JSON payloads
- **Synchronous Middleware**: Handle non-streaming responses
- **Header Management**: Add tracking and debugging headers