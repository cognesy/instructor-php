...
- Laravel queue integration is already supported via deterministic contracts and registries; you don’t need to serialize Agent instances. `packages/addons/src/Agent/Contracts/AgentContract.php`, `packages/addons/src/Agent/Definitions/AbstractAgentDefinition.php`, `packages/addons/src/Agent/Registry/AgentContractRegistry.php`
