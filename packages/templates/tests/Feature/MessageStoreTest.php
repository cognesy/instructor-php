...
it('creates messages from script', function () {
    ...
    $store = $store->applyTo('section-1')->appendMessages(['role' => 'user', 'content' => 'content-1']);
    $store = $store->applyTo('section-1')->appendMessages(['role' => 'assistant', 'content' => 'content-2']);
    $store = $store->applyTo('section-1')->appendMessages(['role' => 'user', 'content' => 'content-3 <|key-1|>']);

    $store = $store->applyTo('section-2')->appendMessages(['role' => 'user', 'content' => 'content-4']);
    $store = $store->applyTo('section-2')->appendMessages(['role' => 'assistant', 'content' => 'content-5']);
    $store = $store->applyTo('section-2')->appendMessages(['role' => 'user', 'content' => 'content-6 <|key-2|>']);
...
it('selects sections from script', function () {
    ...
    $store = $store->applyTo('section-2')->appendMessages(['role' => 'user', 'content' => 'content-4']);
    $store = $store->applyTo('section-2')->appendMessages(['role' => 'assistant', 'content' => 'content-5']);
    $store = $store->applyTo('section-2')->appendMessages(['role' => 'user', 'content' => 'content-6']);

    $store = $store->applyTo('section-3')->appendMessages(['role' => 'user', 'content' => 'content-7']);
    $store = $store->applyTo('section-3')->appendMessages(['role' => 'assistant', 'content' => 'content-8']);
    $store = $store->applyTo('section-3')->appendMessages(['role' => 'user', 'content' => 'content-9 <|key-2|>']);
