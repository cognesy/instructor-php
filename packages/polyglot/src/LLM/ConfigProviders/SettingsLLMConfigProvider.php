...
class SettingsLLMConfigProvider extends SettingsConfigProvider
{
    ...
    protected function createConfig(string $preset): LLMConfig {
        return new LLMConfig(
            ...
            defaultModel    : $this->getSetting("presets.$preset.defaultModel", ''), defaultMaxTokens: $this->getSetting("presets.$preset.defaultMaxTokens", 1000),
            ...
            driver          : $this->getSetting("presets.$preset.providerType", 'openai'),
