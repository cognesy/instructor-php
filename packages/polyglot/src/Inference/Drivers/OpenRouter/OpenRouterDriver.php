...
{
    public function __construct(LLMConfig $config, CanSendHttpRequests $httpClient, EventDispatcherInterface $events,) {
        parent::__construct(
            config: $config,
    ...
    /**
     * OpenRouter does not support response_format alongside tools.
     */
    #[\Override]
