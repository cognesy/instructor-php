...
class QwenDriver extends BaseInferenceRequestDriver
{
    public function __construct(
        ...
        parent::__construct(
            ...
            responseTranslator: new QwenResponseAdapter(
    ...
    /**
     * Qwen does not reliably support response_format alongside tools.
     */
    #[\Override]
