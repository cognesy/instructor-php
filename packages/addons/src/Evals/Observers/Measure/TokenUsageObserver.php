...
class TokenUsageObserver implements CanGenerateObservations
{
     ...
     * @return iterable<\Cognesy\Addons\Evals\Observation> Yields a series of Observation objects.
     */
     ...
     * @return iterable<\Cognesy\Addons\Evals\Observation> Yields Observation objects with token usage.
     */
     ...
     * Generate observations from an Experiment
     *
     * @param \Cognesy\Addons\Evals\Experiment $experiment Observation subject.
     * @return iterable<\Cognesy\Addons\Evals\Observation> Yields Observation objects with token usage.
     */
     ...
     * @return \Cognesy\Addons\Evals\Observation The created Observation object.
     */
