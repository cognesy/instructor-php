...
/**
 * Spawns a critic subagent to evaluate if a proposed response adequately
 * addresses the original task. Returns structured feedback with approval
 * status and improvement suggestions.
 */
