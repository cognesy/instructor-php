...
MARKDOWN;
            ...
            $doctests = iterator_to_array(Doctest::fromMarkdown($markdownFile));
...
---
# Test', '/test.md');
            expect(Doctest::getEffectiveCaseDir($markdownWithExplicit))->toBe('custom/path');
...
---
# Test', '/test.md');
            expect(Doctest::getEffectiveCaseDir($markdownWithoutExplicit))->toBe('examples');
...
---
# Test', '/test.md');
            expect(Doctest::getEffectiveCaseDir($markdownWithEmpty))->toBe('examples');
        });
...
# Test', '/docs/filename.md');
            expect(Doctest::getEffectiveCasePrefix($markdownWithExplicit))->toBe('explicit_');
...
# Test', '/docs/my_file.md');
            expect(Doctest::getEffectiveCasePrefix($markdownWithoutExplicit))->toBe('myFile_');
...
# Test', '/docs/test_document.md');
            expect(Doctest::getEffectiveCasePrefix($markdownWithEmpty))->toBe('testDocument_');
        });
    });
});