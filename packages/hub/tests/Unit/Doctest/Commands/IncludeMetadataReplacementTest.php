...
MARKDOWN;
    ...
    describe('include metadata format compatibility', function () {
        it('generates include paths compatible with GenerateDocs expectations', function () {
            ...
            $originalMarkdown = <<<'MARKDOWN'
---
doctest_case_dir: examples/D03_Docs_HTTP/BasicHttpMiddleware
...
MARKDOWN;
            ...
            expect($modifiedContent)->toContain('include="examples/D03_Docs_HTTP/BasicHttpMiddleware/code_middleware_example.php"');
            ...
            expect($codeBlocks[0]->metadata('include'))->toBe('examples/D03_Docs_HTTP/BasicHttpMiddleware/code_middleware_example.php');
        });
