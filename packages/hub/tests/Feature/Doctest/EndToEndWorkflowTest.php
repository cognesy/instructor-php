...
MARKDOWN;
            ...
            // Step 3: Create Doctest instances and verify filtering
...
MARKDOWN;
            ...
            $modifiedForIncludes = $markdownFile->withReplacedCodeBlocks(function($codeBlock) use ($markdownFile) {
                $caseDir = Doctest::getEffectiveCaseDir($markdownFile);
                $casePrefix = Doctest::getEffectiveCasePrefix($markdownFile);
...
MARKDOWN;
            ...
            // Create doctest
            $doctests = iterator_to_array(Doctest::fromMarkdown($originalFile));
