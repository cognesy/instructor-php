<?php
namespace Cognesy\Experimental\Modules\Markdown;

use Cognesy\Experimental\Module\Core\Module;
use Cognesy\Experimental\Modules\Markdown\Data\Section;
use Cognesy\Experimental\Modules\Markdown\Utils\MarkdownSplitter;
...
class SplitMarkdown extends Module
{
    ...
    /** @return \Cognesy\Experimental\Modules\Markdown\Data\Section[] */
