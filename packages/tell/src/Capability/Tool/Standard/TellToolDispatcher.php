...
final readonly class TellToolDispatcher
{
     ...
     */
    public function dispatch(TellToolRequest $invocation): TellToolResult {
        ...
        $loop = $this->agents->build($request, $this->cancellation);
    ...
    private function failure(string $name, string $code, string $message, ?ToolInterface $tool = null): TellToolResult {
        return new TellToolResult(
            tool: $name,
            success: false,
            data: [],
