...
final readonly class TellCodingTools implements CanProvideAgentCapability
{
    ...
    public function configure(CanConfigureAgent $agent): CanConfigureAgent {
        ...
        $tools = new Tools(
            new StructuredToolAdapter($read, 'read_file', 'read', ['output' => 'line and byte limited']),
            new StructuredToolAdapter($write, 'write_file', 'write', ['newFilesOnly' => true, 'atomic' => true]),
            new ApplyPatchTool($patch),
            new StructuredToolAdapter($shell, 'shell', 'execute', ['network' => false, 'sandboxed' => true]),
        );
