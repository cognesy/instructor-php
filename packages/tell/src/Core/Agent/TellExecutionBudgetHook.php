...
final class TellExecutionBudgetHook implements HookInterface
{
    ...
    private function enforceAfterStep(HookContext $context): HookContext {
        if ($this->toolLimitExceeded) {
            return $this->stop($context, StopReason::ToolCallLimitReached, 'Tell tool-call budget exhausted.', [
        ...
        return $this->stop($context, StopReason::OutputLimitReached, 'Tell model-output budget exhausted.', [
