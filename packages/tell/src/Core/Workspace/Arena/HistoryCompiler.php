...
use Cognesy\Tell\Core\Workspace\Arena\Record\ToolCall as RecordToolCall;
use Cognesy\Tell\Core\Workspace\Arena\Record\ToolResult as RecordToolResult;
use Cognesy\Tell\Core\Workspace\Arena\Record\Turn;
use Cognesy\Tell\Core\Workspace\Arena\Record\TurnStatus;
...
{
    public function compile(CanUseTellWorkspaceArena $store, ?ObjectHash $head): History {
        if ($head === null) {
