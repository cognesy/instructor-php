...
final readonly class TellOptions
{
    ...
    public static function fromInput(InputInterface $input, OutputInterface $output): self {
        ...
        return new self(
            ...
            answers: TellAnswersInput::read($input),
            ...
            policyOverrides: self::executionPolicyOverrides($input),
        );
    }

    public function request(): TellRequest {
        return new TellRequest(
            ...
            mode: $this->transient ? TellExecutionMode::Transient : TellExecutionMode::Automatic,
    ...
    public static function executionPolicyOverrides(InputInterface $input): array {
        $options = [
            ...
            'maxSpillBytes' => '--max-spill-bytes',
            'maxStubBytes' => '--max-stub-bytes',
        ];
        $overrides = [];
