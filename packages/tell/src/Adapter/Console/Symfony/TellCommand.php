...
use Cognesy\Tell\Adapter\Console\Render\HomeScreen;
use Cognesy\Tell\Adapter\Console\Render\HumanRenderer;
use Cognesy\Tell\Adapter\Console\Render\JsonRenderer;
use Cognesy\Tell\Adapter\Console\Render\OutputRenderer;
use Cognesy\Tell\Adapter\Console\Render\StepTrace;
use Cognesy\Tell\Adapter\Console\Render\StructuredOutput;
use Cognesy\Tell\Adapter\Console\Render\TextRenderer;
use Cognesy\Tell\Adapter\Console\Render\ToonRenderer;
...
HELP)
    ...
    private function withBranchSettings(TellOptions $options): TellOptions {
        ...
        $configuration = $this->branchConfiguration->read($options->directory, $options->branch);
        if ($configuration === null) {
            return $options;
        }

        return $options->withBranchConfig($configuration->values);
    }
