...
it('deserializes PHPDoc typed properties', function () {
    $deserializer = new SymfonyDeserializer();
    $json = '{"name": "Jason", "age": 28, "hobbies": ["reading", "coding"], "address": {"city": "New York", "country": "US"}}';
...
it('deserializes complex PHPDoc annotations', function () {
    $deserializer = new SymfonyDeserializer();
    $json = '{"name": "Jane Doe", "age": null, "addresses": [{"city": "New York", "country": "US"}, {"city": "London", "country": "UK"}], "metadata": {"status": "active", "score": 95}}';
...
it('deserializes PHPDoc array types', function () {
    $deserializer = new SymfonyDeserializer();
    $json = '{"name": "Test User", "age": 30, "hobbies": ["swimming", "hiking", "photography"], "address": {"city": "Paris", "country": "FR"}}';
    $class = PersonWithPhpDocTypes::class;
    $object = $deserializer->fromJson($json, $class);
