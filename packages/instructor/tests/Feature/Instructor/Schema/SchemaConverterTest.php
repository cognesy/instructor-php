...
it('creates Schema object from JSON Schema array - collection props', function ($jsonSchema) {
    ...
    expect($schema->properties['collectionObjectProperty']->nestedItemSchema->typeDetails->class)->toBe('Cognesy\Instructor\Tests\Examples\SchemaConverter\TestNestedObject');
    ...
    expect($schema->properties['collectionEnumProperty']->nestedItemSchema->typeDetails->class)->toBe('Cognesy\Instructor\Tests\Examples\SchemaConverter\TestEnum');
