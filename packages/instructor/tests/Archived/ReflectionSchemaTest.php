...
if (!function_exists('createEvent')) {
     ...
     * @param Cognesy\Instructor\Tests\Examples\Complex\Stakeholder[] $stakeholders Stakeholders involved in the event
     * @return Cognesy\Instructor\Tests\Examples\Complex\ProjectEvent
     */
