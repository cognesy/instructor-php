...
describe('SmartBraceMatchingStrategy', function () {
    beforeEach(function () {
        $this->strategy = new SmartBraceMatchingStrategy();
    });

    it('has correct name', function () {
        expect($this->strategy->name())->toBe('smart_brace_matching');
    });
    ...
    it('fails when no valid JSON found', function () {
        $result = $this->strategy->extract('No JSON here at all');
    ...
    it('fails when only invalid JSON present', function () {
        $result = $this->strategy->extract('{invalid: not json}');
    ...
    it('handles unclosed strings gracefully', function () {
        ...
        $result = $this->strategy->extract('{"text":"unclosed string');
