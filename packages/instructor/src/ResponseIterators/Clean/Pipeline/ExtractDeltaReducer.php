...
final class ExtractDeltaReducer implements Reducer
{
    ...
    private function createEmptyBuffer(): ContentBuffer {
        return match ($this->mode) {
            OutputMode::Tools => \Cognesy\Instructor\ResponseIterators\Clean\ContentBuffer\ToolsBuffer::empty(),
            default => \Cognesy\Instructor\ResponseIterators\Clean\ContentBuffer\JsonBuffer::empty(),
        };
    }
    ...
    private function createFrame(
        ...
        return new PartialFrame(
            ...
            emission: \Cognesy\Instructor\ResponseIterators\Clean\Enums\Emission::None,
            metadata: \Cognesy\Instructor\ResponseIterators\Clean\Domain\FrameMetadata::at($index),
        );
    }
