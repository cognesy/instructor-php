...
/**
 * Iterates over chunks from a single attempt using the Clean pipeline.
 *
 ...
 *
 * Architecture: Uses Clean pipeline with:
 ...
 */
final readonly class CleanStreamingUpdateGenerator implements CanStreamStructuredOutputUpdates
{
    public function __construct(
        private InferenceProvider $inferenceProvider,
        private CleanStreamFactory $factory,
    ) {}
    ...
    private function initializeStream(StructuredOutputExecution $execution): StructuredOutputExecution {
        ...
        $aggregateStream = $this->factory->makeObservableStream(
