...
The `capabilityName()` method returns a string identifier used by `AgentCapabilityRegistry` to look up capabilities by name. This is how agent templates reference capabilities in their definition files (see [Agent Templates](14-agent-templates)).
...
[Agent Templates](14-agent-templates#opt-in-composer-manifest-discovery) for
...
- [Basic Agent](02-basic-agent)
- [Hooks](08-hooks)
- [Agent Templates](14-agent-templates)
