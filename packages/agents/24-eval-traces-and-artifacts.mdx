...
- **[Eval assertions](22-eval-assertions)** -- the deterministic assertion catalogue that reads tool names, order, and error flags directly from the trace this page describes.
- **[Eval judges](23-eval-judges)** -- what a judge can and cannot see through the trace under `safe()`, and why judge run cost is reported separately from target cost.
