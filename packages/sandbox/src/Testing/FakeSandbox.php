...
namespace Cognesy\Sandbox\Testing;
...
final class FakeSandbox implements CanExecuteCommand
{
    ...
    private function nextResult(string $key): ExecResult {
        ...
        if ($queued === []) {
            ...
            throw new RuntimeException("FakeSandbox has no response for command: {$key}");
        }
