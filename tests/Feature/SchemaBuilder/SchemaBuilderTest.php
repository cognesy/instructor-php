...
it('creates Schema object from JSON Schema array - enum props', function ($jsonSchema) {
    ...
    expect($schema->properties['enumProperty']->typeDetails->class)->toBe('Tests\Examples\SchemaBuilder\TestEnum');
...
it('creates Schema object from JSON Schema array - object props', function ($jsonSchema) {
    ...
    expect($schema->properties['objectProperty']->typeDetails->class)->toBe('Tests\Examples\SchemaBuilder\TestNestedObject');
    ...
    expect($schema->properties['objectProperty']->properties['nestedObjectProperty']->typeDetails->class)->toBe('Tests\Examples\SchemaBuilder\TestDoubleNestedObject');
...
it('creates Schema object from JSON Schema array - array props', function ($jsonSchema) {
    ...
    expect($schema->properties['arrayObjectProperty']->nestedItemSchema->typeDetails->class)->toBe('Tests\Examples\SchemaBuilder\TestNestedObject');
    ...
    expect($schema->properties['arrayEnumProperty']->nestedItemSchema->typeDetails->class)->toBe('Tests\Examples\SchemaBuilder\TestEnum');
