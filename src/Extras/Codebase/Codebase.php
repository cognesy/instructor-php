<?php
namespace Cognesy\Instructor\Extras\Codebase;

use Cognesy\Instructor\Extras\Codebase\Actions\ExtractClasses;
use Cognesy\Instructor\Extras\Codebase\Actions\ExtractFunctions;
use Cognesy\Instructor\Extras\Codebase\Actions\ExtractNamespaces;
use PhpParser\Node;
