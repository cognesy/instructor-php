...
use Cognesy\Instructor\Utils\Codebase\Actions\ExtractClasses;
use Cognesy\Instructor\Utils\Codebase\Actions\ExtractFunctions;
use Cognesy\Instructor\Utils\Codebase\Actions\ExtractNamespaces;
use PhpParser\Node;
