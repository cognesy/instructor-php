...
{
    public static function fromTypeName(string $typeName) : \Cognesy\Instructor\Features\Schema\Data\Schema\Schema {
    ...
    public static function bool(string $name = '', string $description = ''): \Cognesy\Instructor\Features\Schema\Data\Schema\ScalarSchema {
    ...
    public static function object(string $class, string $name = '', string $description = '', $properties = [], $required = []): \Cognesy\Instructor\Features\Schema\Data\Schema\ObjectSchema {
        return (new SchemaFactory)->object($class, $name, $description, $properties, $required);
    }

    public static function enum(string $class, string $name = '', string $description = ''): \Cognesy\Instructor\Features\Schema\Data\Schema\EnumSchema {
