...
> NOTE: Philosophy behind Instructor was formulated by [Jason Liu](https://twitter.com/jxnlco), the creator of original version of Instructor in Python and adapted for the PHP port.
