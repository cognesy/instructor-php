...
class MiddlewareStack
{
     ...
     *
     * @param CanHandleHttp $driver The HTTP driver to decorate
     * @return CanHandleHttp The decorated driver
     */
    public function decorate(CanHandleHttp $driver): CanHandleHttp
    {
        if (empty($this->stack)) {
            return $driver;
        }
