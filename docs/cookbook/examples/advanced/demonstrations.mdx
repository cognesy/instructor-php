...
use Cognesy\Instructor\Features\Core\Data\Example;use Cognesy\Instructor\Instructor;use Cognesy\LLM\Http\Events\HttpRequestSent;use Cognesy\LLM\LLM\Enums\Mode;
