...
```php
<?php
use Cognesy\Instructor\Data\Messages\Script;use Cognesy\Instructor\Data\Messages\ScriptParameters;use Cognesy\Instructor\Data\Messages\Section;use Cognesy\Instructor\Extras\LLM\Enums\LLMProviderType;
