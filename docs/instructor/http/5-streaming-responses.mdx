...
description: 'Learn how to handle streaming responses using the unified HTTP client API.'
---
...
The unified HTTP client API provides robust support for streaming responses across all supported HTTP client implementations.
