...
// rather than composition, subclass BaseInferenceRequestDriver and name it in the spec.

final class EchoingDriver extends BaseInferenceRequestDriver
{
    #[\Override]
...
$drivers = InferenceDriverRegistry::default()->withDriver(
    name: 'custom-driver',
