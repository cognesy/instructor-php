---
title: 'Send Agent telemetry to Langfuse'
...
This example keeps the normal agent console event output, but also exports the
same execution lifecycle to Langfuse. It is a practical pattern for debugging
agent behavior locally while still keeping a remote execution trace.
...
$events = new EventDispatcher('examples.d05.telemetry-langfuse');
