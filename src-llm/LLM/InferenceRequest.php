...
class InferenceRequest
{
     ...
     *
     * @return \Cognesy\LLM\LLM\Data\CachedContext|null The cached context instance or null if not set.
     */
     ...
     *
     * @param \Cognesy\LLM\LLM\Data\CachedContext|null $cachedContext The cached context to be set, or null to clear it.
