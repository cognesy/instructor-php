...
use Cognesy\LLM\LLM\Contracts\ProviderResponseAdapter;
...
class ModularLLMDriver implements CanHandleInference {
     ...
     *
     * @param \Cognesy\LLM\LLM\InferenceRequest $request The request to be processed, including messages, model, tools, and other parameters.
     ...
     * @return \Cognesy\LLM\LLM\Data\LLMResponse|null The converted LLMResponse object or null if conversion fails.
     */
     ...
     * @return \Cognesy\LLM\LLM\Data\PartialLLMResponse|null The converted PartialLLMResponse object, or null if the conversion is not possible.
     */
