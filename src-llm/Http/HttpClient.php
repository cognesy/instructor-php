...
class HttpClient
{
     ...
     * @param string $client The client configuration name to load.
     * @param EventDispatcher|null $events The event dispatcher instance to use.
     * @return \Cognesy\LLM\Http\Contracts\CanHandleHttp Returns an instance that can handle HTTP operations.
     */
     ...
     *
     * @param \Cognesy\LLM\Http\Contracts\CanHandleHttp $driver The driver capable of handling HTTP requests.
     * @return self Returns the instance of the class for method chaining.
     */
     ...
     *
     * @return \Cognesy\LLM\Http\Contracts\CanHandleHttp The HTTP handler associated with the current context.
     */
